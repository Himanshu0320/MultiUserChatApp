...
public class ClientChatScreen extends JFrame {
	...
	public ClientChatScreen() throws UnknownHostException, IOException {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientChatScreen.class.getResource("/image/icons.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(ClientChatScreen.class.getResource("/image/back.png")));
		...
		//
		// ImageIcon i4=new
		// ImageIcon(ClassLoader.getSystemResource("image/himanshu.png"));
